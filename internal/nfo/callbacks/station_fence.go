...
const (
	...
	FIRST_CAR_PARK_ID         = 162
	FIRST_REVERSE_CAR_PARK_ID = 177
	NUM_CAR_PARKS             = 4

	FIRST_WOODEN_INNER_PLATFORM = 15
	FIRST_WOODEN_OUTER_PLATFORM = 25

	FIRST_CONCRETE_INNER_PLATFORM = 58
	FIRST_CONCRETE_OUTER_PLATFORM = 76

	FIRST_MODERN_INNER_PLATFORM = 116
)
