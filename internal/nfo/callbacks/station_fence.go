...
const (
	...
	FIRST_CAR_PARK_ID         = 177
	FIRST_REVERSE_CAR_PARK_ID = 193
	NUM_CAR_PARKS             = 5

	FIRST_WOODEN_INNER_PLATFORM = 18
	FIRST_WOODEN_OUTER_PLATFORM = 29

	FIRST_CONCRETE_INNER_PLATFORM = 66
	FIRST_CONCRETE_OUTER_PLATFORM = 85

	FIRST_MODERN_INNER_PLATFORM = 129
)
